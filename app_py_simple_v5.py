...
def last_index_for_year(year):
    return 10 if year == 2026 else 22 if year == 2027 else 34
...
st.caption("v5 sin matplotlib para evitar errores de arranque")
...
with tab1:
    ...
    with c1:
        ...
        chart_df = df[["Mes","Final","PPP","Monetario","Mercado"]].set_index("Mes")
